...
/**
 * Class to validate input first name and last name. If there are errors in input
 * value, user will be redirected back to the main form and errors will be shown
 * in an alert box. If all validations are successful, full name will be displayed
 * in this page.
 */
class NameValidation
{
  ...
  public function validateNames()
  {
    ...
    if (!empty($this->error)) {
      ...
      header("Location: ../a1.php?" . $query_params);
      exit();
    } else {
